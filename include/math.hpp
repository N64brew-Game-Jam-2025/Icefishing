...
constexpr int32_t kRandMax = 32767;
...
class TMath {
  ...
  static void setSeed(uint32_t seed) {srand(seed);}
  static int32_t random(int32_t min, int32_t max) {return min + rand() % (max + 1 - min);}
...
class TMath<float> {
  ...
  static inline float mod(float x, float y) {
    return (x - static_cast<uint64_t>(x / y) * y);
  }
  ...
  static float frand(float min, float max) {return min + static_cast <float> (rand()) / ( static_cast <float> (kRandMax / (max - min)));}
...
class TVec2 {
  ...
  T & operator[](uint32_t n) { return mData[n]; }
  T operator[](uint32_t n) const { return mData[n]; }
...
class TMtx44 {
  ...
  float & operator()(uint32_t r, uint32_t c) { return mData[r][c]; }
  float operator()(uint32_t r, uint32_t c) const { return mData[r][c]; }
  ...
  void rotateAxis(TVec3F const &, int16_t);
  void rotateAxisX(int16_t);
  void rotateAxisY(int16_t);
  void rotateAxisZ(int16_t);
  void shear(TVec2F const &, TVec2F const &, TVec2F const &);
  void projective(TVec3F const &);
  ...
  void perspective(int16_t fov_y, float aspect, float n, float f);
...
class TSine {
  ...
  static bool startup(uint32_t bits);
  static void shutdown();

  static float ssin(int16_t x);
  static float scos(int16_t x);
  static float stan(int16_t x);
  static float scot(int16_t x);

  static int16_t atan2(float y, float x);
  static int16_t asin(float y);
  static int16_t acos(float x);

  static constexpr float toRad(int16_t x) {
  ...
  static constexpr float toDeg(int16_t x) {
    constexpr auto kRatio = (
  ...
  static constexpr int16_t fromRad(float x) {
    return static_cast<int16_t>(x / (M_PI * 2.0) * 65536.0);
  }

  static constexpr int16_t fromDeg(float x) {
    return static_cast<int16_t>(x / 360.0F * 65536.0);
  }

  private:

  static float * sSinTable;
  static uint16_t sSinShift;
